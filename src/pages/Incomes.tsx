...
const SortableRow = ({ 
  ...
  return (
    ...
    >
      ...
      <td className="px-4 py-4 text-right text-[#01bfa5] whitespace-nowrap">
          ...
          <div className="flex flex-col md:flex-row items-center justify-end gap-2 w-full md:w-auto order-3 md:order-2">
            <div className="flex items-center gap-2 w-full md:w-auto">
              <div className="relative flex-1 md:w-64">
                ...
                <input
                  type="text"
                  placeholder="Buscar receita, valor, tag, obs..."
                  title="Busca avançada: descrição, categoria, tags, valor, observação"
                  className="h-9 pl-9 pr-9 rounded-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 w-full transition-shadow duration-200"
                  value={searchTerm}
                        ...
                        <React.Fragment key={t.id}>
                          ...
                          <div className="flex items-center gap-4 p-4 bg-white dark:bg-[#2C2C2E] rounded-2xl border border-zinc-100 dark:border-[#2C2C2E] mb-4" onClick={(e) => handleEdit(t.id, e)}>
                            ...
                            <div className="flex flex-col items-end gap-2 shrink-0">
                               <p className="text-[#01bfa5] text-sm">{formatCurrency(t.amount)}</p>
                               <div className="flex items-center gap-2">
